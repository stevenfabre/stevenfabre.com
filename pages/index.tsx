    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center">
        <div className="max-w-lg md:max-w-3xl px-4 md:px-8">
          ...
          <p className="text-lg leading-relaxed mt-8 md:text-xl md:leading-relaxed">
            I’m currently the co-founder and CEO of{" "}
            <a
              className="underline-offset-4 decoration-2 underline decoration-[#ff511a] text-zinc-900 dark:text-zinc-100 hover:text-[#ff511a] focus:text-[#ff511a] focus:outline-none"
            ...
            <a
              className="underline-offset-4 decoration-2 underline decoration-teal-400 text-zinc-900 dark:text-zinc-100 hover:text-teal-400 focus:text-teal-400 focus:outline-none"
            ...
            , a web animation tool for designers that was acquired in April 2016
            by{" "}
            <a
              className="underline-offset-4 decoration-2 underline decoration-[#FF0066] text-zinc-900 dark:text-zinc-100 hover:text-[#FF0066] focus:text-[#FF0066] focus:outline-none"
            ...
            at{" "}
            <a
              className="underline-offset-4 decoration-2 underline decoration-[#006AFF] text-zinc-900 dark:text-zinc-100 hover:text-[#006AFF] focus:text-[#006AFF] focus:outline-none"
            ...
            . I also run{" "}
            <a
              className="underline-offset-4 decoration-2 underline decoration-[#00ebcb] text-zinc-900 dark:text-zinc-100 hover:text-[#00ebcb] focus:text-[#00ebcb] focus:outline-none"
          ...
          <ul className="mt-12 flex flex-wrap gap-6">
            <li>
              <a
                className="flex items-center gap-1 text-zinc-900 dark:text-zinc-100 hover:text-[#1DA1F2] focus:text-[#1DA1F2] rounded focus:underline focus:underline-offset-4 focus:decoration-2 focus:decoration-[#1DA1F2] hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-[#1DA1F2] focus:outline-none"
            ...
            <li>
              <a
                className="flex items-center gap-1 text-zinc-900 dark:text-zinc-100 hover:text-[#0072b1] focus:text-[#0072b1] rounded focus:underline focus:underline-offset-4 focus:decoration-2 focus:decoration-[#0072b1] hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-[#0072b1] focus:outline-none"
